...
# Set up environment
curl -O https://raw.githubusercontent.com/olivercorrea/online_machine_learning_for_music_recommendation1/v7/setup.sh
chmod +x setup.sh
./setup.sh

# SWAP memory
curl -O https://raw.githubusercontent.com/olivercorrea/online_machine_learning_for_music_recommendation1/v7/swap.sh
chmod +x swap.sh
./swap.sh
